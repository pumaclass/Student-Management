...
public class CampManagementApplication {
    ...
    private static void createScore() {
        ...
        System.out.println(studentStore.get(0));
        System.out.println(studentStore.get(0).getStudentId());
        System.out.println(studentStore.indexOf(studentId));

        Score score = new Score();
        score.scoreRegist(studentStore.get(0), 90);
